...
#define RFM95_CS_3 6      // Chip Select (NSS) pin
#define RFM95_INT_3 20     // Interrupt pin (G0 or DIO0)

#define RFM95_CS_4 7
#define RFM95_INT_4 21
...
void loop(){
  ...
  if(i>=2){
    Serial.println("1");
    Serial.println((receivedRSSI[2]+receivedRSSI[6])/2);
    Serial.println((receivedRSSI[1]+receivedRSSI[4])/2);
    Serial.println((receivedRSSI[3]+receivedRSSI[7])/2);
    Serial.println((receivedRSSI[1]+receivedRSSI[5])/2);
    delay(5000);
  }
/*
