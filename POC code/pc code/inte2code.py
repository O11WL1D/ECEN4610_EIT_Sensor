...
def Calibrate(numElectrodes=numElectrodes):
    ...
    arduino = serial.Serial(port='/dev/cu.usbmodem1301', baudrate=9600, timeout=1)  # Replace 'COM3' with your Arduino's port
...
button = Button(root, text='Image', width=25, command=Imaging)
button.pack(pady=10)  # Add some padding for better UI
